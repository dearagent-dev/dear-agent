...
class Evidence:
    ...
    Persisted with the task so ``dear-agent task show`` can point at the PR without reading the
...
class Task:
    ...
    ``id`` is Dear Agent's stable internal task id and ``transport_id`` is the RFC 5322
