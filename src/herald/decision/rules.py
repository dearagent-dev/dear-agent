...
from herald.decision.port import Answer, Decision, DecisionKind, Question
...
class RuleDecider:
    ...
    It answers the decisions Herald makes at the edges — which model class and whether a
